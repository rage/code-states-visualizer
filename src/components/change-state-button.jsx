...
class ChangeStateButton extends Component {
  ...
  render() {
    ...
    return (
      <button
        className={className}
        onClick={() => { this.props.onClick(this.props.index, this.props.direction); }}
        disabled={this.disabled()}
      >
        {this.props.direction.charAt(0).toUpperCase() + this.props.direction.substring(1, this.props.direction.length)}
      </button>
    );
  }
}
